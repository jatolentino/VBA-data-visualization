...
Private Sub chartitle1_Change()

End Sub

Private Sub lefTopRan_Change()

End Sub

Private Sub rightBottomRan_Change()
...
Image2.Picture = LoadPicture("C:\Users\Josetv\Documents\imagetable.jpg")
End Sub
...
'    ActiveChart.SeriesCollection(1).DataLabels.ShowPercentage = True
    ...
    '*****************************************************
    ' Algorithm to change datalabel to % Format
    '*****************************************************
    Dim s As Double
    Dim v As Variant
...
'    End With
    ...
    Chrt.Chart.ChartTitle.Text = Me.chartitle1.Value
    'chartitle1
